...
╚═╝╚═╝  ╚═══╝╚══════╝╚═╝     ╚══════╝ ╚═════╝   ╚═╝    ╚═════╝ ╚═╝  ╚═╝  v1.0
 ...
 {Back.RED}  Created by Bhaskar Soni, Github: @Bhaskar-Soni  {Back.RESET}{Style.RESET_ALL}
"""

# Use this 'BANNER' variable in your script where you want to display the banner.
print(BANNER)
